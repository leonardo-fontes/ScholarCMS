  ...
  return (
    <div className="flex flex-col w-full items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-primary text-xl">
              {user?.name} {user?.surname} Test Woman
            </p>
            <span className="text-gray text-lg">{user?.city || "Cubatão"}</span>
          </div>
        </div>
      ...
      <p className="bg-white rounded-md p-4 max-w-[560px] border-[1px] border-primary ">
        ...
        accusantium harum minus, accusamus optio esse vel minima cumque et
        dolores commodi debitis explicabo, hic non qui cupiditate. Quibusdam,
        optio maiores. Lorem ipsum dolor sit amet consectetur adipisicing elit.
        Nulla exercitationem minus nostrum quam. Eveniet explicabo possimus
        facere quos eos quo delectus quam, id obcaecati repellendus voluptates
        excepturi totam praesentium? Mollitia?
      </p>
      {publication ? (
      ...
      <Button
        classname="my-12 text-lg md:text-2xl font-semibold md:font-bold text-white bg-primary hover:text-primary hover:bg-white w-[560px] md:py-2"
        href="/"
