...
export default function PaymentPage() {
    ...
    return (
        ...
        <div className="w-full flex items-center justify-center">
            {data.status === 0 ? (<div className="w-full max-w-[580px] flex flex-col items-center justify-center shadow-lg p-8">
                <div className="flex flex-col">
                    ...
                    <span className="text-gray text-xs mb-2">
                        Obs: O beneficiário receberá {`R$${recalculatedAmount}`}, pois 3% {`(R$${threePercent})`} do valor é destinado à plataforma.
                    </span>
                </div>
                <Button
                    children={"VOLTAR"}
